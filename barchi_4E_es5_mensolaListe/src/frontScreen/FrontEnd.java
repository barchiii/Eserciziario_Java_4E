...
public class FrontEnd {
    public static Libro LeggiLibro(Scanner keyboard, int nLibri, ArrayList<Libro> scaffale) {
    ...
    public static void visualizza(ArrayList<Libro> scaffale, int nLibri) throws Exception {
